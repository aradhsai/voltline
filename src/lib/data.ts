...
export const LINES: Line[] = [
  {
    id: "drw1",
    name: "DRW-1",
    machine: "Rod breakdown & wire draw",
    ratedKw: 220,
    idleKw: 14,
    maxSpeed: 18,
  ...
  },
  {
    id: "str1",
    name: "STR-1",
    machine: "37-bobbin strander",
    ratedKw: 90,
    idleKw: 6,
    maxSpeed: 42,
    product: "185 mm² Cu conductor",
    continuous: false,
  ...
  },
  {
    id: "ext1",
    name: "EXT-1",
    machine: "XLPE extrusion line (CCV)",
    ratedKw: 315,
    idleKw: 38,
    maxSpeed: 9,
    product: "11 kV 3-core XLPE",
    continuous: true,
  ...
  },
  {
    id: "arm1",
    name: "ARM-1",
    machine: "Steel-wire armouring",
    ratedKw: 75,
    idleKw: 5,
    maxSpeed: 24,
    product: "SWA over bedding",
    continuous: false,
